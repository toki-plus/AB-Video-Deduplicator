...
> 
> 对 **全自动搬运项目** 感兴趣的朋友可以移步我的另一个项目：https://github.com/toki-plus/video-mover
...
4.  **最终效果**：
    ...
    *   关于压缩规律，可以结合 `utils/gen_test_video.py` 和 `utils/extract_frames.py` 对不同平台进行测试。
